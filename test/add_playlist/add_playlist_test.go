...
func TestAddPlaylist(t *testing.T) {
	...
	assert.Equal(t, "Depeche Mode - Never Let Me Down Again (Remastered)", ((*playlist_list_state)[0].PlaylistItems[0].Title))
	assert.Equal(t, "https://i.ytimg.com/vi/snILjFUkk_A/default.jpg", ((*playlist_list_state)[0].PlaylistItems[0].ThumbnailUrl))
